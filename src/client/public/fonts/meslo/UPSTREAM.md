...
wmux uses the `Nerd Font Mono` variant because terminals require predictable single-cell glyph metrics.
It exposes these files to browser CSS as `"MesloLGM Nerd Font"`:
