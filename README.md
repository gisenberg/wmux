...
Prime's internal session name is canonical for automatically owned wmux titles: initial and contextual naming update Prime first, while `/name` changes are mirrored to wmux even while the session is idle. Manual wmux workspace or tab titles remain user-owned and are not overwritten.
