...
- `wmux-hooks install prime-agent` writes an auto-loaded managed extension under `~/.prime/agent/extensions`. It reports top-level prompt start/completion lifecycle and preserves an unmanaged extension at the managed path.
