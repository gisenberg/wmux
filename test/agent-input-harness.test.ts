...
test("broker runtime attestation rejects every predicate with stable sanitized diagnostics and drops pre-ready events", { skip: process.platform === "win32" }, async (t) => {
  ...
  const variants: Array<[string, string, (value: any, challenge: any) => any]> = [
    ...
    ["server URL missing", "server_url_missing", (value) => ({ ...value, diagnostic: "server_url_missing",
      health: { ...value.health, called: false, outcome: "server_url_missing", status: 0, healthy: false, release: "" } })],
    ["server URL invalid", "server_url_invalid", (value) => ({ ...value, diagnostic: "server_url_invalid",
      health: { ...value.health, called: false, outcome: "server_url_invalid", status: 0, healthy: false, release: "" } })],
    ...
    ["health network", "health_network_error", (value) => ({ ...value, diagnostic: "health_network_error",
      health: { ...value.health, called: true, outcome: "network_error", status: 0, healthy: false, release: "" } })],
    ["health redirect", "health_redirect", (value) => ({ ...value, diagnostic: "health_redirect",
      health: { ...value.health, called: true, outcome: "redirect", status: 302, healthy: false, release: "" } })],
    ...
    ["health body", "health_body_too_large", (value) => ({ ...value, diagnostic: "health_body_too_large",
      health: { ...value.health, called: true, outcome: "body_too_large", status: 200, healthy: false, release: "" } })],
    ["health JSON", "health_json_invalid", (value) => ({ ...value, diagnostic: "health_json_invalid",
      health: { ...value.health, called: true, outcome: "json_invalid", status: 200, healthy: false, release: "" } })],
