...
- The runtime-attestation candidate uses agent-input credential schema **3** and broker schema **9**; schema-2 credentials and pre-schema-9 broker files are deliberately disabled during migration.
